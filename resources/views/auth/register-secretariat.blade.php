            ...
            <div class="col-12 col-lg-8">
                <div class="card auth-card border-0 shadow-sm rounded-4 overflow-hidden">
                    ...
                    <div class="auth-header px-4 py-4">
                        <h1 id="register-title" class="h4 text-white mb-1">Registrati come Segreteria</h1>
                        <p class="text-white-50 mb-0">Crea l’account dedicato alle funzioni di segreteria</p>
                    </div>
                        ...
                        <form method="POST" action="{{ route('secretariat.register') }}" aria-describedby="form-desc"
                            ...
                            <div class="d-grid mt-4">
                                <button type="submit" class="btn btn-ficr"
                                    aria-label="Conferma registrazione segreteria">
