...
<head>
    <meta charset="UTF-8">
    <title>Convocazione Cronometristi – Servizio Gara</title>
...
<body>
    <div class="container" role="main">
        ...
        <p><strong>Oggetto:</strong> Convocazione cronometristi –
        ...
        <p>Gentili Cronometristi,</p>

        <p>
            con la presente siete convocati per il servizio di cronometraggio relativo alla manifestazione
